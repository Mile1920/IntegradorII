            ...
            <div class="card-body">
                <form action="{{ isset($cargo) ? route('cargos.update', $cargo) : route('cargos.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $cargo->nombre ?? '') }}" required placeholder="Ej: Ingeniero, Operador">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" rows="4" placeholder="Describe las responsabilidades del cargo...">{{ old('descripcion', $cargo->descripcion ?? '') }}</textarea>
                    </div>
